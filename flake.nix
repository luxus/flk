{
  ...
  inputs = {
    nixos.follows = "nixpkgs/nixos-22.05";
    nixos-unstable.follows = "nixpkgs/nixos-unstable";

    # nixpkgs is a local registry via https://github.com/divnix/quick-nix-registry
    # to be more accessible, uncomment this:
    # nixpkgs.url = "github:NixOS/nixpkgs";
    nixpkgs-unstable.follows = "nixpkgs/nixpkgs-unstable";
    nixpkgs-lock.follows = "nixpkgs-unstable";
  ...
  in
    ...
    }
    {
      ...
      in std.lib."${exports'}".trimBy exports ["lib"];
    }
    {
      # overlays
